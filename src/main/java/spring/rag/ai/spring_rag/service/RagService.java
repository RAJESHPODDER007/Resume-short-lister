...
import spring.rag.ai.spring_rag.tool.LoggerTool;
...
public class RagService {
    ...
    public String retrieveAndGenerate(String message) {
        ...
        ToolCallback[] logTool = ToolCallbacks.from(new LoggerTool());
        ChatOptions chatOptions = ToolCallingChatOptions.builder()
                .toolCallbacks(logTool).build();
        ...
        Prompt prompt = new Prompt(List.of(
                ...
                new UserMessage(message)),chatOptions);
